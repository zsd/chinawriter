...
<!-- Bootstrap start -->
<link type="text/css" rel="stylesheet" href="${ctx}/js/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">
<link type="text/css" rel="stylesheet" href="${ctx}/js/lib/bootstrap/css/invest.css" rel="stylesheet">
<link type="text/css" rel="stylesheet" href="${ctx}/js/boot/css/font-awesome.css" rel="stylesheet">
<link type="text/css" rel="stylesheet" href="${ctx}/js/boot/css/jquery.alerts.css" rel="stylesheet">

<!-- Bootstrap end -->
<%-- end link css file --%>

<%-- start link javascript file --%>
<script type="text/javascript" src="${ctx}/js/lib/jquery-1.8.3.min.js" charset="utf-8"></script>
