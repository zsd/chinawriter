CREATE TABLE `cw_article_config` (
  ...
  `from_web` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '来源链接',
  ...
  `content_path` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '内容路径',
  `publish_date_path` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发布日期路径',
  `publish_date_format` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发布日期格式',
