CREATE TABLE `cw_article` (
  ...
  `is_read` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '是否已读：默认0：未读，1：已读',
  `is_focus` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '是否关注：默认0：不关注，1：关注',
  `remark` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '备注',
  `publish_date` DATETIME COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发布日期',
